...
public class html3270Servlet extends HttpServlet implements Runnable
{
	 ...
	 */
	if(FreeHostConfiguration.getInstance().getFilterMode() > 0)
	    {	
	...
	if(req.getParameter("host") == null && req.getParameter("sessionID") == null)
		...
		Enumeration e = FreeHostConfiguration.getInstance().getHostList();
		int i = 0;
	...
	if(session.isNew())
		...
		out.print("<PRE>\n");			
		rw = new RWHtml3270(FreeHostConfiguration.getInstance().getSessionServerHost(), 
